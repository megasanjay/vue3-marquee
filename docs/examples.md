...
import CardsPauseOnHoverEmits from './examples/CardsPauseOnHoverEmits.vue'
...
<template>
  ...
  <p style="text-align: center">This animation is {{ playState }}.</p>
</template>
